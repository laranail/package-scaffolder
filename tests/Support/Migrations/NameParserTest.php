...
{
    public function test_it_gets_the_original_name(): void
    {
    ...
    public function test_it_gets_the_table_name(): void
    {
        $parser = new NameParser('create_users_table');
    ...
    public function test_it_gets_the_action_name(): void
    {
    ...
    public function test_it_gets_first_part_of_name_if_no_action_was_guessed(): void
    {
        self::assertEquals('something', (new NameParser('something_random'))->getAction());
    }

    public function test_it_gets_the_correct_matched_results(): void
    {
    ...
    public function test_it_gets_the_exploded_parts_of_migration_name(): void
    {
        $parser = new NameParser('create_users_table');
    ...
    public function test_it_can_check_if_current_migration_type_matches_given_type(): void
    {
        $parser = new NameParser('create_users_table');
    ...
    public function test_it_can_check_if_current_migration_is_about_adding(): void
    {
        self::assertTrue((new NameParser('add_users_table'))->isAdd());
    }

    public function test_it_can_check_if_current_migration_is_about_deleting(): void
    {
        self::assertTrue((new NameParser('delete_users_table'))->isDelete());
    }

    public function test_it_can_check_if_current_migration_is_about_creating(): void
    {
        self::assertTrue((new NameParser('create_users_table'))->isCreate());
    }

    public function test_it_can_check_if_current_migration_is_about_dropping(): void
    {
        self::assertTrue((new NameParser('drop_users_table'))->isDrop());
    }

    public function test_it_makes_a_regex_pattern(): void
    {
