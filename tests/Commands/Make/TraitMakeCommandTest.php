...
class TraitMakeCommandTest extends BaseTestCase
{
    ...
    public function test_it_generates_a_new_trait_class()
    {
    ...
    public function test_it_generates_a_new_trait_class_can_override_with_force_option()
    {
    ...
    public function test_it_can_generate_a_trait_in_sub_namespace_in_correct_folder()
    {
    ...
    public function test_it_can_generate_a_trait_in_sub_namespace_with_correct_generated_file()
    {
        $code = $this->artisan('module:make-trait', ['name' => 'Api\\MyTrait', 'module' => 'Blog']);
