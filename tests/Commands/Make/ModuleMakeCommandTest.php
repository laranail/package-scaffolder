...
class ModuleMakeCommandTest extends BaseTestCase
{
    ...
    public function test_it_still_generates_module_if_it_exists_using_force_flag(): void
    {
        Event::fake();
    ...
    {
        $this->app['config']->set(
            'laranail.package-scaffolder.modules.paths.generator.seeder',
        ...
        $this->app['config']->set(
            'laranail.package-scaffolder.modules.paths.generator.route-provider',
    ...
    public function test_it_fires_events_when_module_created(): void
    {
        $module_name = 'Blog';
        Event::fake();
