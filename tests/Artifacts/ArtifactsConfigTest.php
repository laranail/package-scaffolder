...
class ArtifactsConfigTest extends BaseTestCase
{
    ...
    public function test_kinds_map_to_platform_containers()
    {
        $this->assertSame([
    ...
    public function test_plugin_types_include_a_true_none()
    {
    ...
    public function test_core_features_are_listed_and_not_toggleable()
    {
    ...
    public function test_toggleable_features_each_declare_a_default()
    {
    ...
    public function test_web_ui_has_a_livewire_sub_toggle()
    {
    ...
    public function test_namespace_defaults_and_suggestions_are_present()
    {
