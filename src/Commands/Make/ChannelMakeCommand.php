...
final class ChannelMakeCommand extends GeneratorCommand
{
    ...
    {
        return config('laranail.package-scaffolder.modules.paths.generator.channels.namespace')
            ?? $this->strip_app_folder(config('laranail.package-scaffolder.modules.paths.generator.channels.path', 'Broadcasting'));
    }
