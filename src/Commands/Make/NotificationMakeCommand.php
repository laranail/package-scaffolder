...
final class NotificationMakeCommand extends GeneratorCommand
{
    ...
    {
        return config('laranail.package-scaffolder.modules.paths.generator.notifications.namespace')
            ?? $this->strip_app_folder(config('laranail.package-scaffolder.modules.paths.generator.notifications.path', 'Notifications'));
    }
