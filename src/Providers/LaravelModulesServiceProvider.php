...
class LaravelModulesServiceProvider extends ModulesServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Built with the ecosystem-standard fluent AboutSectionDefinition; this
        // provider stays on the laravel-modules fork base (not PackageServiceProvider),
        // so it registers the resolved section via Laravel's AboutCommand directly.
        $about = AboutSectionDefinition::make('Package Scaffolder')
            ->field('Version', fn (): string => (string) InstalledVersions::getPrettyVersion('laranail/package-scaffolder'));

        AboutCommand::add($about->label(), fn (): array => $about->resolve());
