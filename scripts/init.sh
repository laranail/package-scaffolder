#!/usr/bin/env bash
# scripts/init.sh — single bootstrap entrypoint for laranail/package-scaffolder.
...
#   4. Smoke-check lint (non-fatal warnings only).
#   5. Print summary + available composer aliases.
...
# 5. Summary
printf '\n──────────────────────────────────────────\n'
printf '\033[1mlaranail/package-scaffolder\033[0m setup complete\n\n'
...
printf 'Docs: https://laranail.simtabi.com/docs/package-scaffolder/\n'
printf '──────────────────────────────────────────\n'
