...
final readonly class PostData
{
    ...
    public static function fromArray(array $attributes): self
    {
        ...
        return new self(
            ...
            isFeatured: Arr::exists($attributes, 'is_featured') ? (bool) $attributes['is_featured'] : null,
    ...
    private function with(array $overrides): self
    {
        return new self(
            ...
            body: Arr::exists($overrides, 'body') ? $overrides['body'] : $this->body,
            ...
            isFeatured: Arr::exists($overrides, 'isFeatured') ? $overrides['isFeatured'] : $this->isFeatured,
            status: $overrides['status'] ?? $this->status,
            categoryId: $overrides['categoryId'] ?? $this->categoryId,
            authorId: Arr::exists($overrides, 'authorId') ? $overrides['authorId'] : $this->authorId,
